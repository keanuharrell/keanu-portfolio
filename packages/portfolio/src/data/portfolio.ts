export const portfolioData = {
  ...
  experience: [
    {
      ...
      technologies: ["AWS", "SST", "TypeScript", "tRPC", "DynamoDB", "GitHub Actions", "CloudWatch"]
    },
    {
      id: "devops-orisha",
      ...
      technologies: ["Kubernetes", "AWS EKS", "Terraform", "ArgoCD", "GitLab CI", "Prometheus", "Grafana", "Trino"]
    },
    {
  ...
  projects: [
    {
      ...
      longDescription: "Built a powerful terminal interface for AWS resource management, inspired by k9s. Features real-time EC2, IAM, and S3 management with security audit capabilities.",
      highlights: [
    ...
    },
    {
      ...
      longDescription: "Deployed containerized microservices on Kubernetes cluster with comprehensive monitoring and CI/CD automation.",
      highlights: [
      ...
      technologies: ["Kubernetes", "Docker", "Jenkins", "Prometheus", "Grafana", "Helm", "ArgoCD"],
      github: null,
      demo: null,
      featured: true,
      date: "April 2024",
    ...
    },
    {
      ...
      longDescription: "Maintained and optimized production gaming infrastructure with automated scaling and monitoring.",
      highlights: [
  ...
  certifications: [
    { name: "AWS Certified DevOps Engineer", status: "pursuing" },
    { name: "Kubernetes Administrator (CKA)", status: "pursuing" }
  ],
